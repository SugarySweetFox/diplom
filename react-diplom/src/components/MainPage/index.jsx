...
const MainPage=()=>{
    ...
    return <div className={classes.container}>
        ...
        <div className={classes.iti}>
            ...
            <h4>Цель нашего сайта помочь фотографам и мастерам бьюти-индустрии воплотить их идеи в жизнь. А так же моделям преобрести услуги за более низкую стоимость  </h4>
        </div>    
    </div>
}
